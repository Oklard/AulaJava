...
class Relatorio:
    def __init__(self):
        ...
        with open("C:\Users\pauloroberto\OneDrive\Área de Trabalho\TrabalhoC2\src\relatorio_veiculo.sql") as f:
            self.query_relatorio_veiculo = f.read()

        # Abre o arquivo com a consulta e associa a um atributo da classe
        with open("C:\Users\pauloroberto\OneDrive\Área de Trabalho\TrabalhoC2\src\relatorio_vendaVeiculo.sql") as f:
            self.query_relatorio_vendaVeiculo = f.read()

        # Abre o arquivo com a consulta e associa a um atributo da classe
        with open("C:\Users\pauloroberto\OneDrive\Área de Trabalho\TrabalhoC2\src\relatorio_cliente.sql") as f:
